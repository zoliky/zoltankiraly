...
When you’re ready to export to PDF, press C-c C-e (Control-C followed by Control-E) to open the Org Export Dispatcher. Then select Export to LaTeX => As PDF File.
