...
#+OPTIONS: toc:nil <- Disables the table of contents
...
The file is pure LaTeX, but each line is prefixed with Org mode tags like #+LATEX_HEADER:. This helps Emacs handle it properly.
