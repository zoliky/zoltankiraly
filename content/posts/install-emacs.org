...
Before making any changes, it's a good idea to take a snapshot of your system if you're using ZFS. This way, you can easily revert back if something goes wrong during the process. To create a new boot environment, use the following command:
...
#+begin_src sh
pkg install gcc14-devel gmake texinfo
#+end_src
