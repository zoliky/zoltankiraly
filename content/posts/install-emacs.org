...
Before making any changes, it's a good idea to take a snapshot of your system if you have FreeBSD installed on the ZFS filesystem. This way, you can easily revert back if something goes wrong during the process. To create a new snapshot, use the following command:
